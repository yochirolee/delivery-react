...
export default function OrderStatusTrack({ status }) {
  ...
  return (
    <div className="flex flex-row flex-wrap text-center mt-4">
      ...
      <div className={(status=='aceptada')?(classStatus):('rounded-full text-green-400 border border-green-400 w-8 h-8 p-1')}>
        <i className="fa fa-check"></i>
        </div>
        <div className="text-xs font-bold mt-2">Aceptada</div>
      </div>
      <div className="mx-auto w-1/3 text-center  items-center flex flex-col ">
        <div className={(status=='en proceso')?(classStatus):('rounded-full text-green-400 border border-green-400 w-8 h-8 p-1')}>
      ...
      <div className="mx-auto w-1/3 text-center  items-center flex flex-col ">
      <div className={(status=='transportando')?(classStatus):('rounded-full text-green-400 border border-green-400 w-8 h-8 p-1')}>
